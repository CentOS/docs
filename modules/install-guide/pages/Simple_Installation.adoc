...
. Select the entry, that contains the Kickstart configuration, you created in xref:Simple_Installation.adoc#bridgehead.gen-usb-media[Generating the USB Boot Media].
