...
Once all required sections are complete, click the btn:[Begin Installation] button. Also see xref:Write_changes_to_disk_ppc.adoc#sect-write-changes-to-disk-ppc[Begin Installation (ppc)].
