...
You can also specify additional repositories to gain access to more installation environments and software add-ons. See xref:SoftwareSpoke-x86.adoc#sect-package-selection-x86[Software Selection (x86)] for more information.
