...
You can also specify additional repositories to gain access to more installation environments and software add-ons. See <<sect-package-selection-x86>> for more information.
