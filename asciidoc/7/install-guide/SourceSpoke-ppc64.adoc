...
You can also specify additional repositories to gain access to more installation environments and software add-ons. See <<sect-package-selection-ppc>> for more information.
