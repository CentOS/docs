...
[application]*Kickstart* files can be automatically created based on choices made using the graphical interface, through the online [citetitle]_link:++https://access.redhat.com/labsinfo/kickstartconfig++[Kickstart Generator]_ tool, or written from scratch using any text editor. For more information, see <<sect-kickstart-file-create>>.
