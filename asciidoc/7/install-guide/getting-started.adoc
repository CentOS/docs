...
Installation can also be performed in text mode, however certain options, notably including custom partitioning, are unavailable. See <<sect-installation-text-mode-x86>>, or if using an IBM Power system or IBM System z, see <<sect-installation-text-mode-ppc>>, or <<sect-installation-text-mode-s390>>, respectively, for more information.
