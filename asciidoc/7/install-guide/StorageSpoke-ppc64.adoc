...
image::images/diskpartsetup/reclaim-space-ppc.png[This dialog allows you to preserve / shrink / delete existing file systems to generate necessary space for the installation.]
