...
+
You can also use the link:++https://access.redhat.com/labs/vncconfig/++[VNC Configurator] application on the Red{nbsp}Hat Customer Portal to guide you through VNC server and client setup.
