...
[[part-installation-system-z]]
= IBM System{nbsp}z Architecture - Installation and Booting

This part discusses booting, or _initial program load_ (IPL), and installation of {PRODUCT} on IBM System{nbsp}z.

include::Steps-s390.adoc[]

include::S390_Steps_Boot.adoc[]

include::Graphical_Installation-s390.adoc[]

include::Trouble-s390.adoc[]

include::S390_Moreinfo.adoc[]

include::S390_Param.adoc[]

include::S390_References.adoc[]
...
* upgrading a previous release of {PRODUCT} to the current version
...
* performing common post-installation tasks, such as registering the system to Red{nbsp}Hat Subscription Management services
...
include::Deregister_RHN_entitlement.adoc[]
