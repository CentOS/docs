...
image::images/diskpartsetup/reclaim-space-x86.png[This dialog allows you to preserve / shrink / delete existing file systems to generate necessary space for the installation.]
