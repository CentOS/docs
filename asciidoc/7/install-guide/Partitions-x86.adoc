...
For more information, see <<sect-recommended-partitioning-scheme-x86>> for AMD64 and Intel{nbsp}64 systems, <<sect-recommended-partitioning-scheme-ppc>> for IBM Power{nbsp}Systems servers, and <<sect-recommended-partitioning-scheme-s390>> for IBM System{nbsp}z.