...
[[sect-write-changes-to-disk-s390]]
=== Begin Installation
...
image::images/diskpartitioning/write_changes.png[When all required items on the Installation Summary screen have been attended to, the installation can begin.]
